...
import org.github.philipsonfhir.fhirproxy.clinicalreasoning.TestUtil;
...
public class ActivityDefinitionTransformTests {
    ...
    @Test
    public void testProcedureRequest() throws FHIRException, IOException, FhirProxyNotImplementedException {
...
//        System.out.println( ourCtx.newJsonParser().setPrettyPrint( true ).encodeResourceToString( parameters ) );
    ...
    @Test
    public void testCommunication() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition(  )
...
//            .addBodySite( new CodeableConcept().addCoding( new Coding( ).setSystem( "http://example.com").setCode( "someCode" ) ) )
    ...
    @Test
    public void testCommunicationRequest() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testDiagnosticReport() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testMedicationRequest() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testProcedure() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testReferralRequest() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testSupplyRequest() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testObservation() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
...
//            .addDosage( new Dosage().setText("dosage info") )
    ...
    @Test
    public void testNotImplemented() throws FHIRException, IOException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
                .setKind( ActivityDefinition.ActivityDefinitionKind.CAPABILITYSTATEMENT )
                .setTiming( new Timing().addEvent( new Date() ) )
                .setCode( new CodeableConcept().addCoding( new Coding().setCode( "2233" ).setSystem( "a" ) ) )
//                .setLocation( new Reference(  ).setReference( "Location/locationId" ) )
//            .setProduct( new Reference(  ).setReference( "Medication/medicationId" ) )
...
//                .addDosage( new Dosage().setText("dosage info") )
        ...
        try {
            activityDefinitionProcessor = new ActivityDefinitionProcessor( baseFhirDataProvider, activityDefinition, "Patient/patientId" );
            fail("Should have thrown exception");
        } catch (FhirProxyNotImplementedException e) {
        }
    }

    @Test
    public void testTask() throws FHIRException, IOException, FhirProxyNotImplementedException {
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
...
//                .addDosage( new Dosage().setText("dosage info") )
        ...
        activityDefinitionProcessor = new ActivityDefinitionProcessor( baseFhirDataProvider, activityDefinition, "Patient/patientId", "Encounter/encounterId", "Practitioner/prcatitionerId", "Organization/organizationId" );
        IBaseResource resource = activityDefinitionProcessor.getResult();
        assertNotNull( resource );
        assertTrue( resource instanceof Task );
        Task task = (Task) resource;
        assertTrue( task.hasContext() );
        assertTrue( task.hasRequester() );
        assertTrue( task.hasCode() );
    }
}
