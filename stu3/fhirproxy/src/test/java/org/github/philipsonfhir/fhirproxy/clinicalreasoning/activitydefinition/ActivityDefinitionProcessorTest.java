...
public class ActivityDefinitionProcessorTest {
    @Test
    public void testProcedureRequest() throws FHIRException, FhirProxyNotImplementedException {
    ...
    @Test
    public void testReferralRequest() throws FHIRException, FhirProxyNotImplementedException {
        BaseFhirDataProvider baseFhirDataProvider = mock( FhirDataProviderStu3.class );
        ActivityDefinition activityDefinition = (ActivityDefinition) new ActivityDefinition()
    ...
    @Test
    public void testObservation() throws FHIRException, FhirProxyNotImplementedException {
        Date now = new Date();
        BaseFhirDataProvider baseFhirDataProvider = mock( FhirDataProviderStu3.class );
