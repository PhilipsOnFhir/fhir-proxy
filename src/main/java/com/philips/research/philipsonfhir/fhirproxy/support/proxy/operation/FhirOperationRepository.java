...
public class FhirOperationRepository {
    ...
    public FhirOperationCall getGetOperation(FhirServer fhirServerMock, String resourceType, String resourceId, String operationName, Map<String, String> queryparams) {
        FhirResourceInstanceOperation operation = getFhirResourceInstanceOperation( resourceType, operationName );
        if ( operation != null ) {
            return operation.createOperationCall( fhirServerMock, resourceId, queryparams );
        }
        return null;
    }
}
