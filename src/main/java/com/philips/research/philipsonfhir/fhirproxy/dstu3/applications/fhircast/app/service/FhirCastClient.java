...
import com.philips.research.philipsonfhir.fhirproxy.dstu3.support.fhircast.controller.FhirCastException;
...
public class FhirCastClient {
    ...
    @Value("${server.port}")
    public void setPort( String port ) throws FHIRException, FhirCastException {
...
//        this.sessionId = responseEntity.getBody();
    ...
    public void setTopic( String topic ) throws FHIRException, FhirCastException {
...
//        hub.events=patient-open-chart,patient-close-chart
        ...
        fhirCastSessionSubscribe.setHub_events( EventTypes.OPEN_PATIENT_CHART+","+EventTypes.SWITCH_PATIENT_CHART+","+EventTypes.CLOSE_PATIENT_CHART ); //"patient-open-chart,patient-close-chart" );
